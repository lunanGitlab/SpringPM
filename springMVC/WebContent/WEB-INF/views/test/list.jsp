									...
									<div id="dt_example" class="example_alt_pagination">
										...
										<c:if test="${!empty requestScope.studentDao }">	</c:if>
												...
												<tr>
													...
													<th  class="hidden-phone">用戶名</th>
													<th  class="hidden-phone">性別</th>
													<th  class="hidden-phone">年齡</th>
													<th  class="hidden-phone">Email</th>
													<th  class="hidden-phone">所在部门</th>
													<th  class="hidden-phone">现任职务</th>
													<th  class="hidden-phone">联系方式</th>
													<th  class="hidden-phone">QQ号</th>
													<th  class="hidden-phone">微信号</th>
													<th  class="hidden-phone">所学课程</th>
													<th  class="hidden-phone">学习课时</th>
													<th  class="hidden-phone">课程时间</th>
											...
											<tbody>
												...
												<td>${studentDao.sex == 0 ? '先生' : '女士' }</td>
												<td>${studentDao.age }</td>
												<td>${studentDao.email }</td>
												<td>${studentDao.unit }</td>
												<td>${studentDao.post }</td>
												<td>${studentDao.contactNumber }</td>
												<td>${studentDao.qqID }</td>
												<td>${studentDao.weixinID }</td>
												<td>${studentDao.course }</td>
												<td>${studentDao.classHour }</td>
												<td>${studentDao.trainingTime }</td>
												<td>${studentDao.password }</td>
												<td>
													<a href="${pageContext.request.contextPath}/emp/${studentDao.id}">修改</a>&nbsp;&nbsp;&nbsp;
													<a  class="delete-row" data-original-title="Delete" id="del" href="emp/${studentDao.id}"> 
